...
export const t = {
  en: {
    ...
    fullyBookedDisclaimer: (group: string) => `The ${group} workshop is fully booked. You can still register for the other age groups.`,
  ...
  ar: {
    ...
    noSeats: 'لا مقاعد',
    fullyBooked: 'اكتمل الحجز',
    fullyBookedDisclaimer: (group: string) => `ورشة ${group} اكتمل حجزها. لا يزال بإمكانك التسجيل في الفئات العمرية الأخرى.`,
